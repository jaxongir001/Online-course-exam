    ...
    <main>
      <section>
        <div className="container">
          <div className="bg-white flex justify-center items-center mt-32"><img className='bg-red-100 p-2 rounded' src={logo} alt="" /> <span className="text-orange-400 text-5xl font-semibold mr-5">Unlock</span><h1 className="text-5xl font-semibold">Your Creative Potential</h1></div>
          <h2 className='text-center text-3xl mt-7'>with Online Design and Development Courses.</h2>
          <p className='text-center'>Learn from Industry Experts and Enhance Your Skills.</p>
          <div className='flex justify-center items-center gap-3 mt-16'><button className='bg-orange-400 p-3 text-white rounded font-semibold'>Explore Courses</button><button className='border rounded p-3 '>View Pricing</button></div>
        </div>
      </section>
      <section>
        <div className="container">
          <div className='flex justify-between bg-white mt-16 p-10'>
      ...
      <section>
        <div className='container'>
          <div className='flex flex-wrap justify-between gap-y-5 mt-20'>
            ...
            <div className='bg-white p-14 w-1/3'>
              <p className='text-7xl font-semibold text-end  '>02</p>
              <h4 className='text-2xl font-semibold mt-12'>Expert Instruction</h4>
              <p className='mt-4'>Fit your coursework around your existing commitments <br /> and obligations.</p>
              <img className='mt-16 ml-auto border rounded p-2 ' src={orange} alt="" />
            </div>
            <div className='bg-white p-14 w-1/3'>
      ...
      <section>
        <div className="container">
          ...
          <div className='flex flex-wrap gap-y-2 mt-20'>
        ...
        <div className='container'>
          ...
          <div className=' flex items-center justify-between'>
            ...
            <div className='bg-white p-2'>
              <button className='text-white rounded  bg-orange-400 p-3'>
                Monthly
              </button>
          ...
          <div className='flex justify-between mt-20' >
            <div className='border w-2/4 p-12'>
              ...
              <div >
                <div className='flex justify-center items-end mt-12 '><h5 className='text-7xl font-semibold'>$0</h5><span>/month</span></div>
                <p className='font-semibold text-center mt-20'>Available Features</p>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Access to selected free courses.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Limited course materials and resources.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Basic community support.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>No certification upon completion.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Ad-supported platform.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='border rounded p-1' src={x} alt="" /><p>Access to exclusive Pro Plan community forums.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='border rounded p-1' src={x} alt="" /><p>Early access to new courses and updates.</p></div>
              </div>
            ...
            <div className='border w-2/4 p-12'>
              ...
              <div>
                ...
                <p className='font-semibold text-center mt-20'>Available Features</p>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Unlimited access to all courses.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Unlimited course materials and resources.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Priority support from instructors.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Course completion certificates.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 p-1' src={nike} alt="" /><p>Ad-free experience.</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 border rounded p-1' src={nike} alt="" /><p>Access to exclusive Pro Plan community forums..</p></div>
                <div className='flex border item-center gap-1 p-4 justify-start mt-5'><img className='bg-red-50 border rounded p-1' src={nike} alt="" /><p>Early access to new courses and updates.</p></div>
              </div>
